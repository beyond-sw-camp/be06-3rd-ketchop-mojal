                ...
                <div data-v-88fa91b4="" data-v-517e3499="" class="attach-file-wrapper">
                    <div data-v-88fa91b4="" class="attach-file-area">
                        ...
                        <div data-v-88fa91b4="" class="custom-file b-form-file file-input" aria-required="false" aria-invalid="false" id="__BVID__1404__BV_file_outer_">
                            <input type="file" name="uploadFile" accept="image/jpg,image/jpeg,image/png,image/gif,image/bmp,image/heic" multiple="multiple" class="custom-file-input" id="__BVID__1404" style="z-index: -5;">
                            <label data-browse="Browse" class="custom-file-label" for="__BVID__1404">
                                <span class="d-block form-file-text" style="pointer-events: none;">No file chosen</span>
                            </label>
                        </div>
                        <span data-v-746dd3c0="" data-v-88fa91b4="" class="image-count legacy-typography interface-body2 gray-900 text-align-left">0/15</span>
                    </div>
                </div>
                    ...
                    <div data-v-3437dfdd="" class="editor-body-wrapper">
                        <div data-v-067f75d6="" data-v-3437dfdd="" class="editor-title-wrapper">
                            <div data-v-067f75d6="" class="editor-title-container">
                                <label data-v-067f75d6="" for="post-title-input" class="editor-title-label">
                                    <input data-v-746dd3c0="" data-v-067f75d6="" id="post-title-input" type="text" placeholder="제목을 입력해주세요." value="" class="post-title-input legacy-typography headline-subhead5 gray-900 text-align-left">
                                </label>
                            </div>
                        </div>
                        ...
                        <div data-v-c7163a48="" data-v-3437dfdd="" class="editor-contents">
                            <span data-v-746dd3c0="" data-v-c7163a48="" class="legacy-typography interface-body2 gray-900 text-align-left">
                                <textarea data-v-c7163a48="" data-v-746dd3c0="" name="post-content" class="editor-contents-textarea"></textarea>
                            </span>
...
<script>
import PostCreateHeader from '@/components/PostCreateHeader.vue';
import ShareCreateInfoInput from '@/components/ShareCreateInfoInput.vue';
import ExchangeCreateInfoInput from '@/components/ExchangeCreateInfoInput.vue';
