                ...
                <form @submit.prevent="validateForm" data-v-5467bada="" data-v-ac2db00e="" autocomplete="off" class="">
                    <div data-v-5467bada="" class="form-row login-form">
                        <div data-v-5467bada="" class="col-12">
                            <fieldset data-v-5467bada="" class="form-group" :class="{'is-invalid': !nicknameValid}" id="__BVID__361">
                                <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0 left-align" id="__BVID__361__BV_label_">닉네임</legend>
                                <div>
                                    <input v-model="member.nickname" @blur="validateNickname" data-v-5467bada="" name="nickname" type="text" placeholder="닉네임을 입력해주세요" autocomplete="off" class="text-input form-control is-invalid invalid" data-testid="login-email" x-autocompletetype="off" autocorrect="off" spellcheck="false" autocapitalize="off" data-vv-validate-on="blur" aria-invalid="true" id="__BVID__362">
                                    <div v-if="!nicknameValid" data-v-5467bada="" class="invalid-feedback">닉네임을 입력해주세요.</div>
                                </div>
                            </fieldset>
                        </div>
                        <div data-v-5467bada="" class="col-12">
                        ...
                        <div data-v-5467bada="" class="col-12">
                            <fieldset :class="{'is-invalid': !passwordValid}" data-v-5467bada="" class="form-group password" id="__BVID__363">
                                ...
                                <div>
                                    ...
                                    <div v-if="!passwordValid" data-v-5467bada="" class="invalid-feedback">비밀번호를 입력해주세요.</div>
                                </div>
                            </fieldset>
                        </div>
                        <div data-v-5467bada="" class="col-12">
...
export default {
    ...
    methods:{
        ...
        validateNickname() {
            this.nicknameValid = this.member.nickname !== '';
        },
        validateForm() {
            this.validateEmail();
